...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = user?.userMetadata?['name'] as String? ?? email.split('@').first;
    final isAdmin = user?.userMetadata?['role'] == 'admin' || email == 'belloumi.karim.professional@gmail.com';
                ...
                child: ListView(
                  ...
                  children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle,
                                  border: Border.all(color: const Color(0xFF0F170D), width: 3),
                                ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(child: _StatCard(label: 'Bornes', value: '42')),
                          const SizedBox(width: 12),
                          Expanded(child: _StatCard(label: 'Rapports', value: '128')),
                          const SizedBox(width: 12),
                          Expanded(child: _StatCard(label: 'Points', value: '1.2k')),
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('Réussites', style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.bold)),
                          Text('Voir tout', style: TextStyle(color: AppColors.primary, fontSize: 13)),
                        ],
                      ),
                    ),
                    SizedBox(
...
class _AchievementCard extends StatelessWidget {
  ...
  const _AchievementCard({required this.title, required this.subtitle, required this.icon, required this.color, required this.progress});
